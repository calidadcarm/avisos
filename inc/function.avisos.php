...
// porque la select no devuelve campo vac�o.
...
// Funci�n que obtiene los IDs de los avisos que aplican a un item
// S�lo aquellos definidos para ese elemento y que est�n activos
...
// Funci�n que llama al mostrar el elemento
